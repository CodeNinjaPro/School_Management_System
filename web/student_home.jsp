                                ...
                                <div class="col-lg-12">
                                    <div class="card" id="assignment_report">
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">All Assignments</h3>
                                        </div>
                                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">Complete Assignments</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">                       
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="file" type="hidden" class="form-control form-control-warning" multiple>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="UploadServlet" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Please Upload PDF file(Name should be Assignment ID)</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control form-control-warning" type="file" name="file" multiple />
                                                    </div>
                                                </div>
                                                <div class="form-group row">       
                                                    <div class="col-sm-9 offset-sm-3">
